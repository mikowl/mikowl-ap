...
title: My favorite newish CSS things
...
The traditional approach of using a single border radius value can result in imperfect corners that look like <Tooltip client:visible content="My favorite Green Day album tho">dookie</Tooltip>.
