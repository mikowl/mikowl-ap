...
## Playing sounds is finicky <span data-tooltip-id="my-tooltip" data-tooltip-content="as fuck" data-tooltip-place="top">af</span>, particularly on mobile
...
That's the meat and potatoes of it, after each round I call `refetch()` when the gen changes and it fetches a new set of pokemon.
