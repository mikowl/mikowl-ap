...
Shortly after writing about various css in js solutions, Meta released their own solution called [StyleX](https://stylexjs.com/) that looks pretty, pretty, pretty good.

<Image src={prettygood} format="gif" alt="pretty good" className="w-full rounded" />
