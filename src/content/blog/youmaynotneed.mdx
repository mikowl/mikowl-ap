...
<aside>
<Icon pack="ion" name="information-circle-outline" className="float-left translate-y-[3px] -translate-x-1" />
General note, if you're going to be building your own component/UI I highly recommend checking out [ARIA Authoring Practices Guide (APG)](https://www.w3.org/WAI/ARIA/apg/patterns/). It's a great resource for ensuring your UI is accessible and to follow best practices.
</aside>
...
<Accordion client:load heading="Who's the best guitarist of all time?" content="Tony Iommi 🎸🤘🧙🏻‍♂️⚡️" />
